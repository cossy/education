...
<script language="JavaScript" type="text/javascript"  src="artDialog.min.js">
</script>
<script language="JavaScript" type="text/javascript"  src="alert_window.js">
</script>
...
function redirect(x)
{
 var select1_len = $('#subject').find("option").length;
...
select2[0][0] = new Option("请选择", " ");
 //yuwen                                               
select2[1][0] = new Option("人教版","");
select2[1][1] = new Option("语文版", "");
select2[1][2] = new Option("苏教版 ", " ");
select2[1][3] = new Option("鄂教版","");
select2[1][4] = new Option("北师大版", "");
select2[1][5] = new Option("鲁教版", " ");
select2[1][6] = new Option("上海教育出版社","");
select2[1][7] = new Option("沪教版", "");
select2[1][8] = new Option("北京课改版", " ");
select2[1][9] = new Option("浙教版","");
select2[1][10] = new Option("粤教版", "");
select2[1][11] = new Option("长春版", " ");
select2[1][12] = new Option("冀教版", "");
select2[1][13] = new Option("华师大版", " ");
select2[1][14] = new Option("新疆教育出版社","");
//shuxu
select2[2][0] = new Option("人教版", " ");
select2[2][1] = new Option("北师大版", " ");
select2[2][2] = new Option("浙教版", " ");
select2[2][3] = new Option("苏科版 ", " ");
select2[2][4] = new Option("湘教版", " ");
select2[2][5] = new Option("沪科版 ", " ");
select2[2][6] = new Option("北京课改版 ", " ");
select2[2][7] = new Option("华师大版", " ");
select2[2][8] = new Option("青岛版", " ");
select2[2][9] = new Option("冀教版", " ");
select2[2][10] = new Option("青岛版", " ");
select2[2][11] = new Option("新课标人教A版", " ");
select2[2][12] = new Option("新课标人教B版", " ");
//yingyu
select2[3][0] = new Option("冀教版下册", " ");
select2[3][1] = new Option("北师大版", " ");
select2[3][2] = new Option("人教新目标", " ");
select2[3][3] = new Option("牛津译林版", " ");
select2[3][4] = new Option("外研版", " ");
select2[3][5] = new Option("牛津深圳版", " ");
select2[3][6] = new Option("鲁教版", " ");
select2[3][7] = new Option("北京课改版", " ");
select2[3][8] = new Option("牛津上海版", " ");
select2[3][9] = new Option("牛津沈阳版", " ");
select2[3][10] = new Option("仁爱版", " ");
select2[3][11] = new Option("牛津广州版", " ");
select2[3][12] = new Option("重庆大学版", " ");
select2[3][13] = new Option("上海新世纪版", " ");
//wuli                
select2[4][0] = new Option("人教版", " ");
select2[4][1] = new Option("粤教版 ", " ");
select2[4][2] = new Option("江苏版", " ");
select2[4][3] = new Option("鲁科版", " ");
select2[4][4] = new Option("教科版", " ");
select2[4][5] = new Option("北师大版 ", " ");
select2[4][6] = new Option("华师大版 ", " ");
select2[4][7] = new Option("北京课改版", " ");
//huaxue              
select2[5][0] = new Option("人教版", " ");
select2[5][1] = new Option("粤教版 ", " ");
select2[5][2] = new Option("苏教版", " ");
select2[5][3] = new Option("鲁科版", " ");
select2[5][4] = new Option("教科版", " ");
select2[5][5] = new Option("沪教版 ", " ");
select2[5][6] = new Option("仁爱版", " ");
select2[5][7] = new Option("湘教版", " ");
//shengwu              
select2[6][0] = new Option("人教版", " ");
select2[6][1] = new Option("浙教版", " ");
select2[6][2] = new Option("苏教版", " ");
select2[6][3] = new Option("中图", " ");
select2[6][4] = new Option("北师大", " ");
select2[6][5] = new Option("沪科", " ");
select2[6][6] = new Option("浙科", " ");
//zhenzhi                  
select2[7][0] = new Option("人教版", " ");
select2[7][1] = new Option("粤教版", " ");
select2[7][2] = new Option("苏教版", " ");
select2[7][3] = new Option("鲁教版", " ");
select2[7][4] = new Option("北师大版", " ");
select2[7][5] = new Option("湘教版", " ");
select2[7][6] = new Option("教科版", " ");
select2[7][7] = new Option("人民版", " ");
select2[7][8] = new Option("陕教版 ", " ");
//lishi           
select2[8][0] = new Option("川教版", " ");
select2[8][1] = new Option("人教新课标版", " ");
select2[8][2] = new Option("岳麓版", " ");
select2[8][3] = new Option("沪教版", " ");
select2[8][4] = new Option("北师大版", " ");
select2[8][5] = new Option("标准实验版", " ");
select2[8][6] = new Option("大象版", " ");
select2[8][7] = new Option("人民版", " ");
select2[8][8] = new Option("鲁教版", " ");
select2[8][9] = new Option("冀教版", " ");
select2[8][10] = new Option("湘教版", " ");
select2[8][11] = new Option("粤教沪科版", " ");
select2[8][12] = new Option("中华书局版", " ");
select2[8][13] = new Option("中图版", " ");
//dili              
select2[9][0] = new Option("中图版", " ");
select2[9][1] = new Option("人教版", " ");
select2[9][2] = new Option("鲁教版", " ");
select2[9][3] = new Option("湘教版", " ");
select2[9][4] = new Option("商务星球版", " ");
select2[9][5] = new Option("晋教版", " ");
select2[9][6] = new Option("粤教版", " ");

var temp = document.getElementById('edtion');
...
dsy.add("0_1",["北京"]);
dsy.add("0_1_0",["北京市","朝阳区", "海淀区","西城区","东城区","崇文区","宣武区","丰台区","石景山区","门头沟","房山区","通州区","大兴区","顺义区","怀柔区","密云区","昌平区","平谷区","延庆县"]);    
...
dsy.add("0_30",["重庆 <option>一年级</option>
          <option>二年级</option>
          <option>三年级</option>
          <option>四年级</option>
          <option>五年级</option>
...
<body  onload="setup();" bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<div align="center">
...
<div class="container">
				...
				<div style="margin-left:0px;margin-top:0px"><em><h4><font color="gray">用户注册</font></h4></em></div>
				<form class="form-horizontal" action="cgi/regist.php" method="post">
				<div style="border:1px solid #FFEBCD">
 <div class="control-group" style="margin-left:100px">
    <label class="control-label" for="inputEmail"><i class="icon-star"></i>用户类型:</label>
    <div class="controls">
<label style="float:left;margin-right:100px">
  <input type="radio" name="usertype" value="teacher" style="margin-right:20px" onclick="type_change()"><strong>我是老师
</strong></label>
<label style="float:left">
  <input type="radio" name="usertype" value="student" style="margin-right:20px" onclick="type_change()"><strong>我是学生
</strong></label>

    </div>
  </div>
					<div class="control-group" style="margin-left:100px">
    <label class="control-label" for="phonenum"><i class="icon-star"></i>手机:</label>
    <div class="controls">
      <input type="text" id="phonenum" name="phonenum" placeholder="手机号" style="height:30px;width:300px"/>
<button type="button" class="btn btn-info">获取手机验证码</button>
    </div>
  </div>
<div class="control-group" style="margin-left:100px">
    <label class="control-label" for="inputEmail"><i class="icon-star"></i>短信验证码:</label>
    <div class="controls">
      <input type="text" id="checknum" name="checknum" placeholder="验证码" style="height:30px;width:300px"/>
    </div>
  </div>
  <div class="control-group" style="margin-left:100px">
    <label class="control-label" for="nickname"><i class="icon-star"></i>昵称:</label>
    <div class="controls">
      <input type="text" id="nickname" name="nickname" placeholder="昵称" style="height:30px;width:300px">
    </div>
  </div>
 
 
  <div class="control-group" style="margin-left:100px">
    <label class="control-label" for="inputPassword"><i class="icon-star"></i>密码:</label>
    <div class="controls">
      <input type="password" id="inputPassword" name="inputPassword" placeholder="密码" style="height:30px;width:300px">
    </div>
  </div>
  
  <div class="control-group" style="margin-left:100px">
    <label class="control-label" for="passwordAgain"><i class="icon-star"></i>再次输入密码:</label>
    <div class="controls">
      <input type="password" id="passwordAgain" name="again" placeholder="再次输入" style="height:30px;width:300px">
    </div>
  </div>
  <div id="s_first" class="control-group" style="margin-left:100px">
    <label class="control-label"><i class="icon-star"></i>省市区县</label>
    <div class="controls">
      <select id="s1" name="s1" style="width:100px"><option>省份</option></select>
		   <select id="s2" name="s2" style="width:100px"><option>地级市</option></select>
           <select id="s3" name="s3" style="width:100px"><option>区县</option></select>
    </div>
  </div>
  <div id="s_second" class="control-group" style="margin-left:100px">
    <label class="control-label"><i class="icon-star"></i>学校年级</label>
    <div class="controls">
      <select id="school" name="school" style="width:100px">
          <option>学校</option>
          </select>
 ...
 <div id="t_first" class="control-group" style="margin-left:100px">
    <label class="control-label"><i class="icon-star"></i>所交科目</label>
    <div class="controls">
  ...
  <button class="btn btn-success" type="submit" style="margin-left:250px;width:90px">注册</button>
   </div>
...
function type_change(){
	...
	for(var i=0;i<obj.length;i++){
		if(obj[i].checked==true){
			if(obj[i].value=='student'){
				document.getElementById('s_first').style.display='block';
				document.getElementById('s_second').style.display='block';
				document.getElementById('t_first').style.display='none';
			}else{
				document.getElementById('t_first').style.display='block';
				document.getElementById('s_first').style.display='none';
				document.getElementById('s_second').style.display='none';
			}
		}
	}
}
