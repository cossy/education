...
dsy.add("0_11_0",["鄂州市"]);
dsy.add("0_11_1",["巴东http://localhost/s_msgManage.php县","恩施市","鹤峰县","建始县","来凤县","利川市","咸丰县","宣恩县"]);
...
dsy.add("0_16_2",["北票http://localhost/s_msgManage.php市","朝阳市","朝阳县","建平县","喀喇沁左翼蒙古族自治县","凌源市"]);
...
<form id="uploads" method="post" action="cgi/s_modifyInfo.php" enctype='multipart/form-data'>
<div id="input_title" style="font-family: '宋体';font-size:15;float:right;margin-right='30px';width:700px;margin-top:10px">
	...
	<hr style="height:5px">
          <ul>
          <li style="list-style-type:none;margin-bottom:5px;">  昵称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input id="nickname" name="nickname" type="text"></li>
          <li style="list-style-type:none;margin-bottom:5px;">  手机号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="phone_num" name="phone_num" type="text"></li>
          <li style="list-style-type:none;margin-bottom:5px;">  密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" id="inputPassword" name="inputPassword" style="height:30px;width:300px"></li>
          <li style="list-style-type:none;margin-bottom:5px;">  确认密码&nbsp;&nbsp;<input type="password" id="again" name="again" style="height:30px;width:300px"></li>
          <li style="list-style-type:none;margin-bottom:5px;">  省市区县&nbsp;&nbsp;&nbsp;<select id="s1" name="s1" style="width:100px"><option>省份</option></select>
          ...
          <li style="list-style-type:none;margin-bottom:5px;">  学校年级&nbsp;&nbsp;&nbsp;<select id="school" name="school" style="width:100px">
          <option>学校</option>
          </select>
          ...
          <li style="list-style-type:none;margin-bottom:5px;">  我的头像&nbsp;&nbsp;&nbsp;<img id="photo" src="/images/default.jpg" width="180" height="100" alt=""></li>
          <li style="list-style-type:none;margin-bottom:5px;">上传新头像<input type='hidden' name='MAX_FILE_SIZE' value='26211140' /><input type="file" name="upload_file3" /></li>
          <li style="list-style-type:none;margin-bottom:25px;"><button type="button" class="btn btn-primary" style="width:200px;margin-left:30px" onclick="uploads.submit();">修改</button></li>
          </ul>
...
<?php
		...
		$ID=$_SESSION['ID'];
		$type=$_SESSION['type'];
		$_sql="select phone,nickname,password,sheng,shi,qu,school,grade,img from student where ID=$ID";
