...
{  
    //从数据库查询出来的字段
     $name=$row["name"];
     $url="localhost/student".$row["url"];
	 if($i%3==0){
		 echo "<div class='row'>";
	 }
	 echo "<div class='col-lg-4'><img src='images/video.jpg' alt='Generic placeholder image' width='140' height='140'><p style='margin-left:20px'><a class='btn btn-default' href='$url' role='button'>$name</a></p></div>";
	 $i++;
	 if($i%3==0){
		 echo "</div>";
	 }
